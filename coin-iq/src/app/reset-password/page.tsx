...
export default function ResetPasswordPage() {
  ...
  // Get token from URL (we'll simulate this since Next.js 13+ App Router doesn't have useParams in the same way)
  useEffect(() => {
    const urlParams = new URLSearchParams(window.location.search);
    const tokenParam = urlParams.get('token');
    setToken(tokenParam);
    
    // In a real app with dynamic routes like [token], this would be different
    // For now, we'll assume the token is valid until proven otherwise
