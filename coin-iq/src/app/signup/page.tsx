...
import { Eye, EyeOff, TrendingUp, Brain, Shield, BookOpen, Award } from 'lucide-react';
        ...
        <div className="relative z-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h2 className="text-4xl font-black text-white leading-tight mb-4">
              Start trading<br />
              <span className="text-gray-400">smarter today.</span>
            </h2>
            ...
            <div className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
              ...
              <p className="text-sm text-gray-400">
                Join <span className="text-white font-semibold">50,000+</span> traders already using Coin-IQ
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {errors.name && (
                <motion.p initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
                  className="mt-1.5 text-sm text-red-500 font-medium">{errors.name}</motion.p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.email && (
                <motion.p initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
                  className="mt-1.5 text-sm text-red-500 font-medium">{errors.email}</motion.p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.password && (
                <motion.p initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
                  className="mt-1.5 text-sm text-red-500 font-medium">{errors.password}</motion.p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <motion.p initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
                  className="mt-1.5 text-sm text-red-500 font-medium">{errors.confirmPassword}</motion.p>
              )}
            </div>
